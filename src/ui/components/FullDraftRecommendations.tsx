...
export function FullDraftRecommendations({ rows, loadingLabel, selectedId, onSelect }: { rows: Recommendation[]; loadingLabel?: string; selectedId: string | null; onSelect: (championId: string) => void }) {
  const t = useT();
